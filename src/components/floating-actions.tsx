  ...
  return (
    <>
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="animate-float-soft fixed bottom-24 right-4 z-40 inline-flex items-center gap-2 rounded-full bg-[oklch(0.55_0.13_150)] px-4 py-3 text-xs font-bold uppercase tracking-[0.14em] text-white shadow-lift transition hover:brightness-110 md:bottom-6"
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-4 border-t border-border bg-[oklch(0.145_0.004_60_/_0.96)] backdrop-blur-md md:hidden">
